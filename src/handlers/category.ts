...
export const index = async (_req: Request, res: Response) => {
  try {
    ...
    res.json({ msg: 'this is the INDEX route', items: categories });
  } catch (err) {
    res.status(400);
    res.json(err);
  }
...
export const show = async (req: Request, res: Response) => {
  try {
    ...
    res.json({ msg: 'this is the SHOW route', item: category });
  } catch (err) {
    res.status(400);
    res.json(err);
  }
...
export const update = async (req: Request, res: Response) => {
  try {
    ...
    res.json({ msg: 'this is the EDIT route', items: category });
  } catch (err) {
    res.status(400);
    res.json(err);
  }
